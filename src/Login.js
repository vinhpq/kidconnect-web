...
function Login() {
  ...
  const signInWithEmail = (e) => {
    ...
    auth
      ...
      .then(() => {
        auth
          .signInWithEmailAndPassword(email.concat("@nbs.com"), password)
          .then((auth) => {
            console.log(auth);
            dispatch({
    ...
    <div className="login">
      ...
      <div className="login__container">
        ...
        <form action="">
          ...
          />
          <button onClick={signInWithEmail} className="login__signInButton">
            Đăng nhập
          </button>
        </form>
        {/* <button type="submit" onClick={signInWithGoogle} className='login__signInButton'>Đăng nhập với Google</button> */}
        <p>
          By continuing, you agree to NBS 's Conditions of Use and Privacy
          Notice.
        </p>
